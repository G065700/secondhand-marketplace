...
import CategoriesManagingHeader from '@/components/admin/categories/CategoriesManagingHeader';
import CategoriesManagingTable from '@/components/admin/categories/CategoriesManagingTable';
...
const CategoriesManaging = ({ categories }: { categories: Category[] }) => {
  ...
  return (
    <Box sx={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 1 }}>
      ...
      />
      <CategoriesManagingTable fieldArray={fieldArray} register={register} />
    </Box>
  );
};
